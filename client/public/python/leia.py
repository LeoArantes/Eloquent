...
class SentimentIntensityAnalyzer(object):
    ...
    def _but_check(words_and_emoticons, sentiments):
        ...
        for mas in ['mas', 'entretanto', 'todavia', 'porem']:
        ...
        if start_i == 1:
            if words_and_emoticons_lower[i - 2] == "nunca" and \
                ...
                valence = valence * 1.25
                    ...
                    words_and_emoticons_lower[i - 1] == "duvida":
                valence = valence
        ...
        if start_i == 2:
            if words_and_emoticons_lower[i - 3] == "nunca" and \
                ...
                valence = valence * 1.25
                    ...
                    (words_and_emoticons_lower[i - 2] == "duvida" or words_and_emoticons_lower[i - 1] == "duvida"):
                valence = valence
